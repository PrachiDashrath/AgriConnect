...
public class DairyActivity extends AppCompatActivity {
    ...
    String[] dairy = {"Milk", "Butter", "Cheese", "Curd", "Ghee", "Paneer"};
    String farmerPhone = "9876543210";
    String selectedDairy = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this,
                android.R.layout.simple_list_item_1, dairy);
        listView.setAdapter(adapter);

        listView.setOnItemClickListener((parent, view, position, id) -> {
            selectedDairy = dairy[position];
            Intent smsIntent = new Intent(Intent.ACTION_VIEW, Uri.fromParts("sms", farmerPhone, null));
            smsIntent.putExtra("sms_body", "Hello, I want to buy " + selectedDairy + ".");
        ...
        btnSms.setOnClickListener(v -> {
            String item = selectedDairy != null ? selectedDairy : "dairy products";
            Intent smsIntent = new Intent(Intent.ACTION_VIEW, Uri.fromParts("sms", farmerPhone, null));
