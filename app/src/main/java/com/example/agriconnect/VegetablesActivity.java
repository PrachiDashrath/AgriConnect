...
public class VegetablesActivity extends AppCompatActivity {
    ...
    String[] vegetables = {"Tomato", "Potato", "Onion", "Carrot", "Cabbage", "Spinach", "Cauliflower"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            selectedVegetable = vegetables[position];
            Intent smsIntent = new Intent(Intent.ACTION_VIEW, Uri.fromParts("sms", farmerPhone, null));
            smsIntent.putExtra("sms_body", "Hello, I want to buy " + selectedVegetable + ".");
        ...
        btnSms.setOnClickListener(v -> {
            String item = selectedVegetable != null ? selectedVegetable : "vegetables";
            Intent smsIntent = new Intent(Intent.ACTION_VIEW, Uri.fromParts("sms", farmerPhone, null));
